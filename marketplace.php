  ...
  var observer = new IntersectionObserver(function (entries) {
    entries.forEach(function (entry) {
      if (entry.isIntersecting) {
        var el = entry.target;
        var delay = 0;
        if (el.classList.contains('delay-1')) delay = 100;
        else if (el.classList.contains('delay-2')) delay = 200;
        else if (el.classList.contains('delay-3')) delay = 300;
