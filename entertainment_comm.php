<?php
$pageTitle = "Entertainment Committee — DHLTU SRC";
...
$committee = $committeeModel->getBySlug('Entertainment-Committee');
...
<head>
  ...
  <title><?php echo htmlspecialchars($committee['name'] ?? 'Entertainment Committee'); ?> — DHLTU SRC</title>
  ...
  <main class="section" style="padding-top: 160px; min-height: 80vh;">
    <div class="container">
      ...
      <header class="section-header" style="margin-bottom: 40px;">
        <span class="section-eyebrow" style="letter-spacing:0.15em; color:var(--gold); font-family:'Space Mono'; font-size:11px;">CULTURE & STUDENT LIFE</span>
        <h1 style="font-family:'Cormorant Garamond'; font-size:clamp(32px, 5vw, 48px); color:var(--cream);">Entertainment <span style="color:var(--gold-light); font-style:italic;">Committee</span></h1>
        <p style="max-width: 700px; margin: 20px auto 0 auto; color:var(--text-muted); line-height:1.6;"><?php echo htmlspecialchars($committee['description'] ?? 'Curating vibrant campus entertainment, organising cultural showcases, talent events, and recreational activities that enrich student life beyond the classroom.'); ?></p>
      </header>
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 14px;">
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Cultural Events Programming</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Planning year-round cultural happenings — from artist showcases and talent nights to cultural weeks — bridging tradition and modern youth engagement.</p>
            </div>
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Community Building & Engagement</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Fostering inclusive spaces and social cohesion through recreational activities, themed weeks, and inter-faculty programmes across the student body.</p>
            </div>
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Student Talent Development</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Running talent identification programmes and masterclasses enabling students to showcase and develop creative skills in music, dance, drama, and public speaking.</p>
            </div>
          </div>
        </div>
      </div>
