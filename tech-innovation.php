...
$committee = $committeeModel->getBySlug('Tech & Innovation Committee');
if (!$committee) {
    $committee = $committeeModel->getBySlug('Tech-Innovation-Committee');
}
...
<head>
  ...
  <title><?php echo htmlspecialchars($committee['name'] ?? 'Tech & Innovation Committee'); ?> — DHLTU SRC</title>
...
<a href="index.php#committees" class="back-link" style="text-decoration:none; color:var(--gold); font-family:'Space Mono'; font-size:12px; display:inline-flex; align-items:center; gap:8px; margin-bottom:24px;">
      ...
      <header class="section-header" style="margin-bottom: 40px;">
        <span class="section-eyebrow" style="letter-spacing:0.15em; color:var(--gold); font-family:'Space Mono'; font-size:11px;">TECHNOLOGY & INNOVATION</span>
        <h1 style="font-family:'Cormorant Garamond'; font-size:clamp(32px, 5vw, 48px); color:var(--cream);">Tech & <span style="color:var(--gold-light); font-style:italic;">Innovation Committee</span></h1>
        <p style="max-width: 700px; margin: 20px auto 0 auto; color:var(--text-muted); line-height:1.6;"><?php echo htmlspecialchars($committee['description'] ?? 'Driving digital transformation across campus through technology solutions, innovation labs, and student tech initiatives.'); ?></p>
      </header>
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 14px;">
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Digital Infrastructure Development</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Implementing smart campus solutions, improving internet connectivity, and maintaining student-facing digital platforms.</p>
            </div>
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Student Tech Training</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Organizing workshops on coding, digital literacy, and emerging technologies to enhance student employability.</p>
            </div>
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Innovation Hub Management</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Overseeing maker spaces, robotics labs, and collaborative innovation centers for student projects.</p>
            </div>
          </div>
        </div>
      </div>
