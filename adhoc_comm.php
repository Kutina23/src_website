...
$committee = $committeeModel->getBySlug('Ad-Hoc Committees');
...
<head>
  ...
  <title><?php echo htmlspecialchars($committee['name'] ?? 'Ad-Hoc Committees'); ?> — DHLTU SRC</title>
  ...
  <main class="section" style="padding-top: 160px; min-height: 80vh;">
    <div class="container">
      ...
      <header class="section-header" style="margin-bottom: 40px;">
        <span class="section-eyebrow" style="letter-spacing:0.15em; color:var(--gold); font-family:'Space Mono'; font-size:11px;">SPECIAL TASKFORCE & APPOINTMENTS</span>
        <h1 style="font-family:'Cormorant Garamond'; font-size:clamp(32px, 5vw, 48px); color:var(--cream);">Ad-Hoc <span style="color:var(--gold-light); font-style:italic;">Committees</span></h1>
        <p style="max-width: 700px; margin: 20px auto 0 auto; color:var(--text-muted); line-height:1.6;"><?php echo htmlspecialchars($committee['description'] ?? 'Temporary investigative organs and event boards assembled by executive request to address time-sensitive student developments.'); ?></p>
      </header>
          ...
          <div>
            ...
            <div style="display: flex; flex-direction: column; gap: 14px;">
              <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
                <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">SRC Celebrations & Week Management</h4>
                <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Coordinating vendors, booking venue grids, and organizing entertainment logistics for the annual student integration festival.</p>
              </div>
              <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
                <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Leadership Candidate Vetting Processes</h4>
                <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Auditing the academic standing, GPA metrics, and constitutional compliance profiles of student aspirants ahead of election timelines.</p>
              </div>
              <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
                <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Emergency Review & Special Investigations</h4>
                <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Launching focused review teams to respond to urgent student affairs issues and deliver timely executive recommendations.</p>
              </div>
            </div>
          </div>
        </div>
