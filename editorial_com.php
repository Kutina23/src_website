...
$committee = $committeeModel->getBySlug('Editorial & Press Committee');
...
<head>
  ...
  <title><?php echo htmlspecialchars($committee['name'] ?? 'Editorial Committee'); ?> — DHLTU SRC</title>
...
<a href="index.php#committees" class="back-link" style="text-decoration:none; color:var(--gold); font-family:'Space Mono'; font-size:12px; display:inline-flex; align-items:center; gap:8px; margin-bottom:24px;">
      ...
      <header class="section-header" style="margin-bottom: 40px;">
        <span class="section-eyebrow" style="letter-spacing:0.15em; color:var(--gold); font-family:'Space Mono'; font-size:11px;">COMMUNICATIONS & PUBLICATIONS</span>
        <h1 style="font-family:'Cormorant Garamond'; font-size:clamp(32px, 5vw, 48px); color:var(--cream);">Editorial & <span style="color:var(--gold-light); font-style:italic;">Press Committee</span></h1>
        <p style="max-width: 700px; margin: 20px auto 0 auto; color:var(--text-muted); line-height:1.6;"><?php echo htmlspecialchars($committee['description'] ?? 'Managing all official student publications, maintaining transparency, releasing newsletters, and documenting historical SRC developments.'); ?></p>
      </header>
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 14px;">
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Information Verification & Newsletters</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Collating cross-campus reports, sorting press updates, and curating the annual SRC student magazine blueprint cleanly.</p>
            </div>
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Media Strategy & Public Announcements</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Drafting unified communiqués to combat misleading coverage, and managing the official notice-board documentation pipelines.</p>
            </div>
          </div>
        </div>
      </div>
