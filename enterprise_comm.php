<?php
$pageTitle = "Enterprise Committee — DHLTU SRC";
...
$committee = $committeeModel->getBySlug('Enterprise-Committee');
...
<head>
  ...
  <title><?php echo htmlspecialchars($committee['name'] ?? 'Enterprise'); ?> — DHLTU SRC</title>
  ...
  <main class="section" style="padding-top: 160px; min-height: 80vh;">
    <div class="container">
      ...
      <header class="section-header" style="margin-bottom: 40px;">
        <span class="section-eyebrow" style="letter-spacing:0.15em; color:var(--gold); font-family:'Space Mono'; font-size:11px;">SPONSORSHIP & REVENUE</span>
        <h1 style="font-family:'Cormorant Garamond'; font-size:clamp(32px, 5vw, 48px); color:var(--cream);">Enterprise <span style="color:var(--gold-light); font-style:italic;">Committee</span></h1>
        <p style="max-width: 700px; margin: 20px auto 0 auto; color:var(--text-muted); line-height:1.6;"><?php echo htmlspecialchars($committee['description'] ?? 'Driving sustainable enterprise partnerships, securing sponsorships, and maximising revenue opportunities to fund SRC programmes and student initiatives.'); ?></p>
      </header>
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 14px;">
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Sponsorship Acquisition & Partnerships</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Identifying, negotiating, and securing sponsorships from corporate bodies, NGOs, and institutions to fund SRC programmes and student events throughout the academic year.</p>
            </div>
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Revenue Generation & Fundraising</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Designing and executing fundraising campaigns, raffles, merchandise drives, and paid events to generate sustainable internal revenue for the SRC treasury.</p>
            </div>
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Brand Alignment & Visibility</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Ensuring all sponsorships and partnerships align with the SRC brand values and public image, while maximising sponsor visibility across campus and digital platforms.</p>
            </div>
          </div>
        </div>
      </div>
