...
$committee = $committeeModel->getBySlug('Sponsorship Committee');
...
<head>
  ...
  <title><?php echo htmlspecialchars($committee['name'] ?? 'Sponsorship Committee'); ?> — DHLTU SRC</title>
  ...
  <main class="section" style="padding-top: 160px; min-height: 80vh;">
    <div class="container">
      ...
      <header class="section-header" style="margin-bottom: 40px;">
        <span class="section-eyebrow" style="letter-spacing:0.15em; color:var(--gold); font-family:'Space Mono'; font-size:11px;">FINANCIAL DEVELOPMENT & PARTNERSHIPS</span>
        <h1 style="font-family:'Cormorant Garamond'; font-size:clamp(32px, 5vw, 48px); color:var(--cream);">Sponsorship <span style="color:var(--gold-light); font-style:italic;">Committee</span></h1>
        <p style="max-width: 700px; margin: 20px auto 0 auto; color:var(--text-muted); line-height:1.6;"><?php echo htmlspecialchars($committee['description'] ?? 'Engaging telecom brands, external corporate executives, and local ventures to offset operational costs through beneficial mutual contracts.'); ?></p>
      </header>
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 16px; margin-bottom: 32px;">
            ...
            <?php else: ?>
              ...
              <div class="card" style="padding: 20px; display: flex; align-items: center; gap: 20px; background:rgba(15,32,64,0.5); border:1px solid var(--gold);">
                <div style="width: 48px; height: 48px; border: 1px solid var(--gold); display:flex; align-items:center; justify-content:center; color:var(--gold); font-size:18px; border-radius:4px;"><i class="bi bi-star-fill"></i></div>
                <div>
                  <span style="font-size: 10px; font-family:'Space Mono'; text-transform: uppercase; color: var(--gold); font-weight:600;">Committee Chairperson</span>
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 14px;">
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Corporate Proposals & Pitch Decks</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Drafting professional, corporate-grade pitch documents detailing student demographics to secure multi-year funding grants.</p>
            </div>
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Brand Activation Supervision</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Allocating high-traffic retail spaces on campus to commercial sponsors for corporate pop-ups during active academic events.</p>
            </div>
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">B2B Communication Channels</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Managing ongoing emails, follow-up calls, and presenting performance reports to corporate marketing heads.</p>
            </div>
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Sponsor ROI Fulfillment</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Ensuring proper brand exposure on all official flyers, banners, and digital platforms as agreed in contract packages.</p>
            </div>
          </div>
        </div>
      </div>
