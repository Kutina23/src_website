<?php
$pageTitle = "Student Welfare & Health Committee — DHLTU SRC";
...
$committee = $committeeModel->getBySlug('Student-Welfare-&-Health-Committee');
...
<head>
  ...
  <title><?php echo htmlspecialchars($committee['name'] ?? "Student Welfare & Health"); ?> — DHLTU SRC</title>
  ...
  <main class="section" style="padding-top: 160px; min-height: 80vh;">
    <div class="container">
      ...
      <header class="section-header" style="margin-bottom: 40px;">
        <span class="section-eyebrow" style="letter-spacing:0.15em; color:var(--gold); font-family:'Space Mono'; font-size:11px;">HEALTH & SOCIAL WELLBEING</span>
        <h1 style="font-family:'Cormorant Garamond'; font-size:clamp(32px, 5vw, 48px); color:var(--cream);">Student Welfare & <span style="color:var(--gold-light); font-style:italic;">Health Committee</span></h1>
        <p style="max-width: 700px; margin: 20px auto 0 auto; color:var(--text-muted); line-height:1.6;"><?php echo htmlspecialchars($committee['description'] ?? 'Championing holistic student wellbeing through health campaigns, psychosocial support programmes, and disability-access advocacy across the campus community.'); ?></p>
      </header>
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 14px;">
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Health Campaigns & Disease Prevention</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Running sustained awareness campaigns on malaria, HIV, water sanitation, mental health destigmatisation, and conducting wellness screenings across residence halls and faculties.</p>
            </div>
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Psychosocial & Crisis Support</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Operating peer-support counsellors, early-unplanned-pregnancy SOS hotlines, and management-led outreach strategies to provide emergency assistance to students in crisis.</p>
            </div>
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Disability Access Advocacy</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Ensuring infrastructural and programme access for students with disabilities, partnering with Student Services to implement measurable accommodation milestones and reporting.</p>
            </div>
          </div>
        </div>
      </div>
