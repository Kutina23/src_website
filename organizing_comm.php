<?php
$pageTitle = "Organizing Committee — DHLTU SRC";
...
$committee = $committeeModel->getBySlug('Organizing-Committee');
...
<head>
  ...
  <title><?php echo htmlspecialchars($committee['name'] ?? 'Organizing Committee'); ?> — DHLTU SRC</title>
  ...
  <main class="section" style="padding-top: 160px; min-height: 80vh;">
    <div class="container">
      ...
      <header class="section-header" style="margin-bottom: 40px;">
        <span class="section-eyebrow" style="letter-spacing:0.15em; color:var(--gold); font-family:'Space Mono'; font-size:11px;">ASSEMBLY & EVENT PLANNING</span>
        <h1 style="font-family:'Cormorant Garamond'; font-size:clamp(32px, 5vw, 48px); color:var(--cream);">Organizing <span style="color:var(--gold-light); font-style:italic;">Committee</span></h1>
        <p style="max-width: 700px; margin: 20px auto 0 auto; color:var(--text-muted); line-height:1.6;"><?php echo htmlspecialchars($committee['description'] ?? 'Coordinating General Assembly logistics, major convocation events, and high-stakes campus programmes — from planning to the final applause.'); ?></p>
      </header>
      ...
      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 40px;">
        ...
        <div>
          ...
          <div style="display: flex; flex-direction: column; gap: 14px;">
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">General Assembly Coordination</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Departing motions and ballots, convening session pre-work, summoning delegates, and delivering formal ceremonial ceremonies across assemblies.</p>
            </div>
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Event Production & Logistics</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Running rigging, stage design, lighting, sound, camera angles, and run-of-show files for spectacles, cultural events, and institutional galas involving the SRC at large.</p>
            </div>
            <div class="info-card" style="padding: 20px; background: rgba(26,48,96,0.3); border-left: 3px solid var(--gold);">
              <h4 style="font-size: 15px; margin: 0 0 6px 0; color: var(--gold-light);">Stakeholder Engagement & Outreach</h4>
              <p style="font-size: 13px; margin: 0; color: var(--text-muted); line-height: 1.5;">Engaging faculty, departments and student bodies through campus-wide campaigns, sensitisation drives, and registrar-backed awareness visits.</p>
            </div>
          </div>
        </div>
      </div>
